...
const fetchusers = async () => {
    ...
    const response = await axiosClient.get('/admin/users', { headers });
    return response.data; // Assuming your API response contains an array of users
};
...
const AllUsers = () => {
    ...
    const { data: users, isLoading, isError, error } = useQuery({
        queryKey: ['users'],
        queryFn: fetchusers, // Use the function directly here
    });
                                ...
                                <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
                                    ...
                                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                            {users.map((user) => (
                                                <UserlistTile key={user._id} user={user} />
                                            ))}
